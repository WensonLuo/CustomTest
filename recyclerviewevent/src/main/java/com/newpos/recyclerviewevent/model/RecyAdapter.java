package com.newpos.recyclerviewevent.model;
...
import com.newpos.recyclerviewevent.R;
...
public class RecyAdapter extends RecyclerView.Adapter<RecyAdapter.ViewHolder>{
    ...
    public RecyAdapter(int item_layout, List<String> mDataList, boolean isFirstSpecial) {
        this(item_layout, mDataList);
